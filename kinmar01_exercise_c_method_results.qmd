...
format: 
  pdf:
    ...
    header-includes: |
      ...
      \fancyhead[C]{}
      \fancyhead[R]{Marius King, April 28, 2025}
editor: visual
...
Regarding community-weighted means (CWMs) of functional traits, specific leaf area (SLA) was significantly higher in meadows compared to lawns (@fig-traits_cwm). No significant differences were found for seed mass and canopy height.
